...
export default {
  methods: {
    ...
    gui() {
      ...
      this.$refs.example.appendChild(gui.domElement)
    },
    init() {
      var initScene,
        render,
      ...
      this.$refs.example.appendChild(render_stats.domElement)
      ...
      scene.add(light)
      this.createGround(this.$withBase("/assets/textures/general/wood-2.jpg"))
