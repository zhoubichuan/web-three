  ...
  methods: {
    init() {
      ...
      function createMesh(geom, imageFile) {
        ...
        var texture = loader.load(this.$withBase("/assets/textures/crate_color8.tga"))
        var mat = new THREE.MeshPhongMaterial()
        mat.map = texture
    ...
    init() {
      ...
      var controls = new (function () {
        ...
        this.loadCube1 = function () {
          ...
          loader.load(this.$withBase("/assets/models/UVCube1.obj"), function (geometry) {
        ...
        this.loadCube2 = function () {
          var loader = new THREE.OBJLoader()
          loader.load(this.$withBase("/assets/models/UVCube2.obj"), function (geometry) {
            if (mesh) scene.remove(mesh)
            var material = new THREE.MeshBasicMaterial({ color: 0xffffff })
            var texture = THREE.ImageUtils.loadTexture(
              this.$withBase("/assets/textures/ash_uvgrid01.jpg")
...
<template>
  <div style="position:relative">
    ...
    <video
      ...
      src=this.$withBase("/assets/movies/Big_Buck_Bunny_small.ogv")
      controls="true"
      autoplay="true"
    ></video>
    <div ref="example"></div>
