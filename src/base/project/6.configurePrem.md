...
export default {
  methods: {
    ...
    geometry() {
      return {
        shape: new THREE.ShapeGeometry(this.drawShape()),
      }
    },
    // 材质
    material(geom) {
    ...
    drawShape() {
      var svgString = document.getElementById("batmanPath").getAttribute("d")
    ...
    init() {
      ...
      var shape = this.material(new THREE.ShapeGeometry(this.drawShape()))
      scene.add(shape)
      ...
      var controls = new (function () {
        ...
        this.asGeom = function () {
          ...
          shape = that.material(
            new THREE.ExtrudeGeometry(that.drawShape(), options)
          )
          scene.add(shape)
        }
      })()
