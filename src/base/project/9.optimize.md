...
export default {
  methods: {
    init() {
      ...
      var texture = THREE.ImageUtils.loadTexture(this.$withBase("/assets/textures/Metro01.JPG"))
      //texture.wrapS = texture.wrapT = THREE.MirroredRepeatWrapping;
      loader.load(this.$withBase("/assets/models/city.obj"), this.$withBase("/assets/models/city.mtl"), load)
...
export default {
  methods: {
    init() {
      ...
      loader.load(this.$withBase("/assets/models/monster.dae"), function (collada) {
...
export default {
  methods: {
    init() {
      ...
      var loader = new THREE.JSONLoader()
      loader.load(this.$withBase("/assets/models/ogre/ogro.js"), function (geometry, mat) {
        geometry.computeMorphNormals()

        var mat = new THREE.MeshLambertMaterial({
          map: THREE.ImageUtils.loadTexture(
            this.$withBase("/assets/models/ogre/skins/skin.jpg")
          ),
          morphTargets: true,
          morphNormals: true,
        })
...
export default {
  methods: {
    init() {
      ...
      loader.load(this.$withBase("/assets/models/gltf/Cesium_Air.gltf"), function (scene) {
        console.log(scene)
      })
