    ...
    init() {
      ...
      function createPointCloud(
        ...
        var texture = THREE.ImageUtils.loadTexture(
          that.$withBase("/assets/textures/particles/raindrop-3.png")
        )
        var geom = new THREE.Geometry()
    ...
    init() {
      ...
      function createPointClouds(
        ...
        var texture1 = THREE.ImageUtils.loadTexture(
          that.$withBase("/assets/textures/particles/snowflake1.png")
        )
        var texture2 = THREE.ImageUtils.loadTexture(
          that.$withBase("/assets/textures/particles/snowflake2.png")
        )
        var texture3 = THREE.ImageUtils.loadTexture(
          that.$withBase("/assets/textures/particles/snowflake3.png")
        )
        var texture4 = THREE.ImageUtils.loadTexture(
          that.$withBase("/assets/textures/particles/snowflake5.png")
        )
