...
export default {
  methods: {
    ...
    init() {
      ...
      var meshMaterial1 = createMaterial(0)
      var meshMaterial2 = createMaterial(1)
      var meshMaterial3 = createMaterial(2)
      var meshMaterial4 = createMaterial(3)
      var meshMaterial5 = createMaterial(4)
      var meshMaterial6 = createMaterial(5)
      ...
      function createMaterial(index) {
        ...
        `
        var fragShader = fragShaderData[index]
